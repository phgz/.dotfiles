...
if [ "$platform" == "Darwin" ]; then
    ...
    $brew install fish node fontconfig wget python@"$PYTHON_VERSION" wezterm helix dbeaver-community firefox postman rectangle slack subler transmission vlc zoom tokei luajit stats nushell duf
