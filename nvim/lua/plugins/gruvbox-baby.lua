return {
	"luisiacc/gruvbox-baby", -- Color scheme
	lazy = true,
	config = function()
		local theme = require("gruvbox-baby.theme")
		local colors = require("gruvbox-baby.colors").config({ transparent_mode = true, use_original_palette = false })
